...
Measure payload headroom against 1,232-byte legacy and 4,096-byte v1 ceilings.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. TXv1 Size Lab explores a focused consumer use of that space while making the wire budget visible.
